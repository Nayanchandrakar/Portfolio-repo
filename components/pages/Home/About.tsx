...
const About: FC = () => {
    ...
    return <section  className='my-8 lg:mb-12 relative border border-zinc-700' id='about'>
            ...
            <div className="px-1 mx-auto max-w-7xl sm:px-8">
                <div className="items-center py-6 lg:flex ">
                    ...
                    {/* image div here  */}
                        <div className="relative flex h-full w-full max-w-[32rem] items-center justify-center  rounded-lg  bg-background px-40 pb-20 pt-72 md:pb-60 md:shadow-xl">
